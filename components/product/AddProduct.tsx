...
export default function AddProduct({edit, id, product}: { edit?: boolean; id?: string; product?: ProductEditProps })
{
    ...
    const handleSubmit = async (e: FormEvent) => {
        e.preventDefault();
        if(edit && product){
            const updatedProduct = await updateProduct(product.id, {name, description, price, category, images});
            if(updatedProduct)
